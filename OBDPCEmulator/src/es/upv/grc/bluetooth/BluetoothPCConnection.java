...
public class BluetoothPCConnection extends BluetoothConnection {
    String stringUuid = "0000110100001000800000805F9B34FB";

    public BluetoothPCConnection(ECUVehicle data, BluetoothConnectionHandler handler) {
        super(data, handler, "OBDIIEmulator");
    }
